...
function calculateTip() {
  billAmount = 12;
  tip = .2;
  tipAmount = (billAmount * tip).toFixed(2)
...
celsiusConversion = ((Temp -32) * 5/9).toFixed() 

fahrenheitConversion = ((Temp * 9/5 ) + 32).toFixed()

console.log(`${Temp} 'F' is  ${celsiusConversion} Celsius`)
console.log(`${Temp} 'C' is  ${fahrenheitConversion} Fahrenheit `)
